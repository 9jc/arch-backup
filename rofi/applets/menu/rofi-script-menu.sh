...
xvideos="  Xvideos                          (14)"
pornhub="  Pornhub                          (15)"
xhamster="  Xhamster                         (16)"
nerd_fonts="  Nerd Fonts                       (17)"
...
case $chosen in
    ...
    $torrent)
        ...
        ;;
    $xvideos)
        $app --incognito --new-window https://www.xvideos.com &
        ;;
    $pornhub)
        $app --incognito --new-window https://www.pornhub.com &
        ;;
    $xhamster)
        $app --incognito --new-window http://xhamster.com &
        ;;
    $nerd_fonts)
        $app https://www.nerdfonts.com/cheat-sheet &
        ;;
esac
}
...
case $chosen in
    ...
    $mpv_telegram) # open all videos in Telegram Desktop Folder as playlist 
        mpv --osd-bar=no ~/Telegram\ Desktop/*
        ;;
    $quick_wipe)
        alacritty -e bash 
        ;;
