...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=#ef233c
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=#c1121f
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=#00916e
  ...
  function my_git_formatter() {
    ...
    local      clean='#ffff' # black foreground
