...
try:
    ...
    # Option 2 - Download Torrent--------------------- 2
        ...
        download_what = input(choose_option)

        # Prompt Search for torrent to download
        if download_what == "1":
            os.system("clear||cls")
            print(f"{you_choose} {download_what}")
            query = Prompt.ask(search_download_torrent)
            # Finding Torrents ------------------------------- 4
            ...
            down_prog = os.system(f'aria2c "{mag_url}"')
            print(down_prog)
            # exit(1)
            
        # Prompt to give magnet url to download
        elif download_what == "2":
            os.system("clear||cls")
            print(f"{you_choose} {stream_what}")
            mag_url = Prompt.ask(link_download_torrent)
