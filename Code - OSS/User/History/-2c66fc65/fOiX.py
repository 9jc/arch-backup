...
you_choose = "{red} ➤ You Choose Option"
...
# Download Torrent-----------------------
search_download_torrent = (f"\n{yellow} {magenta} Enter the search term you want to {green}[ Download Torrent ]{magenta} of {red}➤ ")
link_download_torrent = (f"\n{yellow} {magenta} Enter the magnet link you want to {green}[ Download Torrent ]{magenta} from {red}➤ ")
