...
# Apply the wallpaper 
def apply_wallpaper(apply_wallpapers):
    if apply_wallpapers == "yes" or "y":
        os.system(f"feh --bg-fill {path}/{file_name}")
    elif apply_wallpapers == "no" or "n":
        os.system(f"feh {path}/{file_name}")
    elif apply_wallpapers == "no" or "n":
        print("Done!!")
        exit()
    else:
        ...
        apply_wallpapers()
apply_wallpapers(apply_wallpapers=input1)
