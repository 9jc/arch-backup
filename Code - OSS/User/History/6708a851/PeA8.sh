...
if  [[ $1 = "--dark-pink" ]]; then
	...
	▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
	--dark-pink --dark-pink2 --dark-purple --dark-blue 
	--dark-cyan --dark-green --dark-lgreen  --dark-red 
	--dark-yellow --dark-orange --dark-white --dark-brown  
	--grey-blue --grey-green --gruvbox  --dark  --cherry
	▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
	_EOF_
fi
