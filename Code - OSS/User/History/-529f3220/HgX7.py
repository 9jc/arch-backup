...
def add_collection():
    ...
    global collection_name, collection_url
    ...
    if collection_type_ask == 'yes' or 'y' or 'YES' or 'Y':
        collection_type_nsfw = "nsfw_collection"
        global collection_type_nsfw
    elif collection_type_ask == 'n' or 'no' or 'NO' or 'N':
        collection_type_sfw = "sfw_collection"
        global collection_type_sfw
    else:
