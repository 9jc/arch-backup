...
collection_id_1 = collection_url.replace(f"https://wallhaven.cc/user/cudiedgar/favorites/", "") # Replacing First Part
print(collection_id_1)
strip_id = re.search("p", collection_id_1) # searching for "/" character in collection_username_1
