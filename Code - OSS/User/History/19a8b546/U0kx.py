...
content = file.read()
Wallheaven_Collection = json.loads(content)

wallpaper_sfw = json.loads(Wallheaven_Collection.text) #sfw walls
wall_json_sfw = wallpaper_sfw['sfw_collection'] #using json and extracting the data var
image_link_sfw = (wall_json_sfw['collection_name'])     #link to random sfw wallpaper
