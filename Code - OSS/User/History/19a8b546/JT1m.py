...
wallheaven_collection = file.read()
wallpaper_sfw_collection = json.loads(wallheaven_collection) #sfw walls
wall_json_sfw = wallpaper_sfw_collection['sfw_collection'] #using json and extracting the data var
image_link_sfw = (wall_json_sfw[2]['collection_name'])     #link to random sfw wallpaper
        
print(image_link_sfw)
