...
vpn_status() {
    if ifconfig wg0 | grep -q "00-00-00-00-00-00-00-00-00-00-00-00-00-00-00-00" || echo Hi ; then
      echo Wireguard Connected 
    elif ifconfig tun0 | grep -q "00-00-00-00-00-00-00-00-00-00-00-00-00-00-00-00" || true ; then
      echo Openvpn Connected 
    elif ifconfig utun420 | grep -q "00-00-00-00-00-00-00-00-00-00-00-00-00-00-00-00" || true ; then
